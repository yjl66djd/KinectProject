...
public class CubeGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private bool Gesture5 = false;
	private bool Gesture4 = false;
	...
	public void UserDetected(long userId, int userIndex)
	{
		...
		manager.DetectGesture(userId, KinectGestures.Gestures.Gesture1);
        manager.DetectGesture(userId, KinectGestures.Gestures.Jump);
        manager.DetectGesture(userId, KinectGestures.Gestures.Gesture2);
        manager.DetectGesture(userId, KinectGestures.Gestures.Gesture3);
		manager.DetectGesture(userId, KinectGestures.Gestures.Gesture4);
        manager.DetectGesture(userId, KinectGestures.Gestures.Gesture5);
	                              ...
	                              KinectInterop.JointType joint, Vector3 screenPos)
	{
		...
		{ 
			Debug.Log("第一个动作完成");
            gestureType = GestureType.Gesture1;
            Gesture1 = true;
        }
		else if (gesture == KinectGestures.Gestures.Gesture2)
        {
            Debug.Log("第二个动作完成");
            gestureType = GestureType.Gesture2;
            Gesture2 = true;
        }
        else if (gesture == KinectGestures.Gestures.Gesture3)
        {
            Debug.Log("第三个动作完成");
            gestureType = GestureType.Gesture3;
            Gesture3 = true;
        }
        else if (gesture == KinectGestures.Gestures.Tpose)
        {
			Debug.Log("第四个动作完成");
            gestureType = GestureType.Tpose;
            Tpose = true;
        }
        else if (gesture == KinectGestures.Gestures.Gesture5)
        {
           // Debug.Log("第五个动作完成");
            Gesture5 = true;
        }
		...
		{
             Debug.Log("跳跃啦666！");
			if ( FindObjectOfType<CookingBar>())
			{
                FindObjectOfType<CookingBar>().AddProgress(0.25f);

            } 
        }
        else 
		{
            gestureType = GestureType.GestureLose;
            //Debug.Log("第四个动作完成");
            Tpose = true;
		}
