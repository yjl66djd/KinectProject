...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        public float[] Current_colours_array;
        Color transparent;
        Color32[] cur_colors;
...
//////////////////////////////////////////////////////////////////////////////
        ...
        {
             Debug.Log( drawable_texture.GetPixel(0, 0).a);
            drawable_texture.SetPixels(clean_colours_array);
           
            drawable_texture.Apply();
        }

        public void GetCurrentPixleAplha()
        {
            Current_colours_array = new float[(int)drawable_sprite.rect.width * (int)drawable_sprite.rect.height];
            int index = 0;
            for (int y = 0; y < (int)drawable_sprite.rect.height; y++)
            {
                for (int x = 0; x < (int)drawable_sprite.rect.width; x++)
                {
                    Current_colours_array[0] = drawable_texture.GetPixel(0, 0).a;
                    index++;
                }
            } 
        }
        ...
        void Awake()
        {
            ...
            for (int x = 0; x < clean_colours_array.Length; x++)
            {
                ...
                //clean_colours_array[x] = drawable_texture.GetPixel(x, x <= (int)drawable_sprite.rect.width ? 0 : x / (int)drawable_sprite.rect.width); 
            }
            GetCurrentPixleAplha();
            //for (int x = 0; x < Current_colours_array.Length; x++)
            //{
            //    Debug.Log(Current_colours_array[x]);
            //}
